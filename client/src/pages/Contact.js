        ...
        return (
          <Card title="Câu hỏi chung">
            <Form layout="vertical" onFinish={onFinish}>
              ...
              <Form.Item>
                <Button type="submit" htmlType="submit">Gửi tin nhắn</Button>
              </Form.Item>
            </Form>
          </Card>
        );
        ...
        return (
          <Card title="Đóng góp ý kiến">
            <Form layout="vertical" onFinish={onFinish}>
              ...
              <Form.Item>
                <Button type="submit" htmlType="submit">Gửi đóng góp</Button>
              </Form.Item>
            </Form>
          </Card>
        );
        ...
        return (
          <Card title="Hỗ trợ khách hàng">
            <Form layout="vertical" onFinish={onFinish}>
              ...
              <Form.Item>
                <Button type="submit" htmlType="submit">Gửi yêu cầu hỗ trợ</Button>
              </Form.Item>
            </Form>
          </Card>
        );
